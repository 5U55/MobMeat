...
public class ModItems {
	...
	public static final Item COOKED_RAVAGER_MEAT = new Item(new Item.Settings().group(ItemGroup.FOOD).food((new FoodComponent.Builder()).hunger(8).saturationModifier(9f).statusEffect(new StatusEffectInstance(StatusEffects.NAUSEA, 900, 2), 1f).statusEffect(new StatusEffectInstance(StatusEffects.LEVITATION, 100, 1), 1f).statusEffect(new StatusEffectInstance(StatusEffects.SPEED, 900, 3), 1f).meat().build()));
